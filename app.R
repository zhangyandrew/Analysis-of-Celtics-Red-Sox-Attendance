...
ui <- pageWithSidebar(
  ...
  sidebarPanel(
    selectInput("dataset", "Choose a dataset:", 
                choices = c(
                              "Baseball_Attendance&Temperature_By_Year",
                              "Baseball_Attendance&Opponent_By_Year",
                              "Baseball_Attendance&SpecialWeather_By_Year",
                              "Basketball_Attendance&Temperature_By_Year",
                              "Basketball_Attendance&Opponent_By_Year",
                              "Basketball_Attendance&SpecialWeather_By_Year"
                )),
...
server <- function(input, output) {
  ...
  #         "Baseball_Attendance&Temperature_By_Year"=baseball_alltime,
  #         "Baseball_Attendance&Opponent_By_Year"=baseball_opp,
   #        "Baseball_Attendance&SpecialWeather_By_Year"=baseball_SpecialWeather
   #        )
    if(input$dataset=="Baseball_Attendance&Temperature_By_Year"&input$Year==2012){
      datasetInput <- baseball
    }
    else if(input$dataset=="Baseball_Attendance&Temperature_By_Year"&input$Year==2013){
      datasetInput<-baseball_2013
    }
    else if(input$dataset=="Baseball_Attendance&Temperature_By_Year"&input$Year==2014){
      datasetInput<-baseball_2014
    }
    else if(input$dataset=="Baseball_Attendance&Temperature_By_Year"&input$Year==2015){
      datasetInput<-baseball_2015
    }
    else if(input$dataset=="Baseball_Attendance&Temperature_By_Year"&input$Year==2016){
      datasetInput<-baseball_2016
    }
    else if(input$dataset=="Baseball_Attendance&Temperature_By_Year"&input$Year==2017){
      datasetInput<-baseball_2017
    }
  else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2012){
      datasetInput<-baseball_opp
  }
    else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2013){
      datasetInput<-baseball_opp13
    }
    
    else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2014){
      datasetInput<-baseball_opp14
    }
    else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2015){
      datasetInput<-baseball_opp15
    }
    else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2015){
      datasetInput<-baseball_opp15
    }
    else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2016){
      datasetInput<-baseball_opp16
    }
    else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"&input$Year==2017){
      datasetInput<-baseball_opp17
    }
    else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"&input$Year==2012){
      datasetInput<-baseball_SpecialWeather
    }
    else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"&input$Year==2013){
      datasetInput<-baseball_SpecialWeather13
    }
    else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"&input$Year==2014){
      datasetInput<-baseball_SpecialWeather14
    }
    else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"&input$Year==2015){
      datasetInput<-baseball_SpecialWeather15
    }
    else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"&input$Year==2016){
      datasetInput<-baseball_SpecialWeather16
    }
    else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"&input$Year==2017){
      datasetInput<-baseball_SpecialWeather17
    }
   # "Basketball_Attendance&Temperature_By_Year",
   # "Basketball_Attendance&Opponent_By_Year",
   # "Basketball_Attendance&SpecialWeather_By_Year"
    else if(input$dataset=="Basketball_Attendance&SpecialWeather_By_Year"&input$Year==2017){
      datasetInput<-basketball_SpecialWeather17
    }
    else if(input$dataset=="Basketball_Attendance&SpecialWeather_By_Year"&input$Year==2016){
      datasetInput<-basketball_SpecialWeather16
    }
    else if(input$dataset=="Basketball_Attendance&SpecialWeather_By_Year"&input$Year==2015){
      datasetInput<-basketball_SpecialWeather15
    }
    else if(input$dataset=="Basketball_Attendance&SpecialWeather_By_Year"&input$Year==2014){
      datasetInput<-basketball_SpecialWeather14
    }
    else if(input$dataset=="Basketball_Attendance&SpecialWeather_By_Year"&input$Year==2013){
      datasetInput<-basketball_SpecialWeather13
    }
    else if(input$dataset=="Basketball_Attendance&SpecialWeather_By_Year"&input$Year==2012){
      datasetInput<-basketball_SpecialWeather
    }
    else if(input$dataset=="Basketball_Attendance&Temperature_By_Year"&input$Year==2012){
      datasetInput<-bball
    }
    else if(input$dataset=="Basketball_Attendance&Temperature_By_Year"&input$Year==2013){
      datasetInput<-bball_2013
    }
    else if(input$dataset=="Basketball_Attendance&Temperature_By_Year"&input$Year==2014){
      datasetInput<-bball_2014
    }
    else if(input$dataset=="Basketball_Attendance&Temperature_By_Year"&input$Year==2015){
      datasetInput<-bball_2015
    }
    else if(input$dataset=="Basketball_Attendance&Temperature_By_Year"&input$Year==2016){
      datasetInput<-bball_2016
    }
    else if(input$dataset=="Basketball_Attendance&Temperature_By_Year"&input$Year==2017){
      datasetInput<-bball_2017
    }
    else if(input$dataset=="Basketball_Attendance&Opponent_By_Year"&input$Year==2012){
      datasetInput<-bball_opp
    }
    else if(input$dataset=="Basketball_Attendance&Opponent_By_Year"&input$Year==2013){
      datasetInput<-bball_opp13
    }
    else if(input$dataset=="Basketball_Attendance&Opponent_By_Year"&input$Year==2014){
      datasetInput<-bball_opp14
    }
    else if(input$dataset=="Basketball_Attendance&Opponent_By_Year"&input$Year==2015){
      datasetInput<-bball_opp15
    }
    else if(input$dataset=="Basketball_Attendance&Opponent_By_Year"&input$Year==2016){
      datasetInput<-bball_opp16
    }
    else if(input$dataset=="Basketball_Attendance&Opponent_By_Year"&input$Year==2017){
 ...
 # output$caption <- renderPrint(
   ...
   # }
   # else if(input$dataset=="Baseball_Attendance&Temperature_By_Year"){
   #   paste0("Please select the Year")
   # }
   # else if(input$dataset=="Baseball_Attendance&Opponent_By_Year"){
   #   paste0("Please select the Year")
   # }
   ...
   #   paste0("Year 2012 Represents all the time")
  #  }
   # else if(input$dataset=="Baseball_Attendance&SpecialWeather_By_Year"){
   #   paste0("Please select the Year")
   # }
  #    )
