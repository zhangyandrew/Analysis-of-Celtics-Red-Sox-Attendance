...
=======
baseball_opp <- baseball %>% group_by(Opp) %>% summarise(avg_attendance = mean(avg_attendance))
baseball <- arrange(baseball_opp, desc(avg_attendance))

ggplot(baseball, aes(Opp, avg_attendance)) +
  geom_bar(stat = "identity") + ggtitle("Average attendance vs. opponents in six seasons") + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
>>>>>>> 129505194fe9a1a2e8c2f16ee32e6d2002cf1ac9
