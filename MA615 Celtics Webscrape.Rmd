...
attend2012$Date[1:14] <- str_c(attend2012$Date[1:14], " 2011")
attend2012$Date[15:40] <- str_c(attend2012$Date[15:40], " 2012")

attend2013$Date[1:17] <- str_c(attend2013$Date[1:17], " 2012")
attend2013$Date[18:41] <- str_c(attend2013$Date[18:41], " 2013")
...
attend2015$Date[18:42] <- str_c(attend2015$Date[18:42], " 2015")
...
wattend2012$Year <- 2013
wattend2013$Year <- 2014
wattend2014$Year <- 2015
wattend2015$Year <- 2016
wattend2016$Year <- 2017
```
